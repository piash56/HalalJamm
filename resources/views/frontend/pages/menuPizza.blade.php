        ...
        <section class="page-banner-area overlay pt-215 rpt-150 pb-160 rpb-120 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/background/banner.jpg);">
            <div class="container">
                <div class="banner-inner text-white">
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Menu pizza</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <li class="breadcrumb-item active">Menu pizza</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row gap-90">
                            <div class="col-lg-6 pb-30" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food1.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food2.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food9.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food3.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food4.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                        <h5><span class="title">shawarma</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                        <p>Diverse menu features array delectable</p>
                            ...
                            <div class="col-lg-6 pb-30" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food5.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food6.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                        <h5><span class="title">Beef burger</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                        <p>Diverse menu features array delectable</p>
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food10.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                        <h5><span class="title">shawarma</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                        <p>Diverse menu features array delectable</p>
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food7.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/pm-food8.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
