    ...
    <!-- header area end -->
        ...
        <section class="page-banner-area overlay pt-215 rpt-150 pb-160 rpb-120 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/background/banner.jpg);">
            <div class="container">
                <div class="banner-inner text-white">
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Menu Sea Food</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <li class="breadcrumb-item active">Menu Sea Food</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        <div class="about-image-four style-two mb-30" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            <div class="row">
                                <div class="col">
                                    <img src="{{ asset('/assets/images/about/about-four5.jpg') }}" alt="About">
                                </div>
                                <div class="col mt-80">
                                    <img src="{{ asset('/assets/images/about/about-four6.jpg') }}" alt="About">
                                </div>
                            </div>
        ...
        <section class="restaurant-menu-area pb-130 rpb-100 rel z-1">
                        ...
                        <div class="row no-gap">
                            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                                <div class="popular-menu-wrap">
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu1.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                            <h5><span class="title">Grilled sausages</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                            <p>Diverse menu features array of delectable</p>
                                        </div>
                                    </div>
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu2.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                            <h5><span class="title">Grilled sausages</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                            <p>Diverse menu features array of delectable</p>
                                    ...
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu3.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu4.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                            <h5><span class="title">mince wrapped</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                            <p>Diverse menu features array of delectable</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                <div class="popular-menu-wrap">
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu5.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu6.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                            <h5><span class="title">Mediterranean grill</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                            <p>Diverse menu features array of delectable</p>
                                        </div>
                                    </div>
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu7.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="food-menu-item style-two">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/food/seafood-menu8.png') }}" alt="Burger Menu">
                                        </div>
                                        <div class="content">
                                            <h5><span class="title">Steamed crabs</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                            <p>Diverse menu features array of delectable</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="testimonials-shapes">
                <div class="shape one">
                    <img src="{{ asset('/assets/images/shapes/crabs-shape2.png') }}" alt="Shape">
                </div>
                <div class="shape four">
                    <img src="{{ asset('/assets/images/shapes/crabs-shape.png') }}" alt="Shape">
                </div>
            </div>
        </section>
