...
@section('content')
    ...
    <!-- header area end -->
        ...
        <section class="page-banner-area overlay pt-215 rpt-150 pb-160 rpb-120 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/background/banner.jpg);">
            <div class="container">
                <div class="banner-inner text-white">
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Menu Grill</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <li class="breadcrumb-item active">Menu Grill</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="about-us-area pt-130 rpt-100 pb-150 rpb-60 rel z-1">
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        <div class="about-image-part style-two mb-30 rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            <img src="{{ asset('/assets/images/food/gril.png') }}" alt="About Pizza">
            ...
            <span class="about-bg-text">Roasted chicken</span>
        </section>
        <!-- About Us Area end -->
                        ...
                        <div class="row gap-90">
                            <div class="col-lg-6 pb-30" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food1.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food2.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                        <h5><span class="title">Grilled sausages</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                        <p>Diverse menu features array delectable</p>
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food3.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food4.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-lg-6 pb-30" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food5.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                        <h5><span class="title">spices & utensils</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                        <p>Diverse menu features array delectable</p>
                                    </div>
                                </div>
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food6.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                        <h5><span class="title">Grilled sausages</span> <span class="dots"></span> <span class="price">$25</span></h5>
                                        <p>Diverse menu features array delectable</p>
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food7.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="food-menu-item style-two">
                                    <div class="image">
                                        <img src="{{ asset('/assets/images/food/gm-food8.png') }}" alt="Food Menu">
                                    </div>
                                    <div class="content">
