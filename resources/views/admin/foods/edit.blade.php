@extends('layouts.vertical', ['title' => 'Edit Food'])
          ...
          <div class="col-12">
               <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                         <h4 class="card-title">Edit Food: {{ $menu->name }}</h4>
                         <a href="{{ route('admin.foods.index') }}" class="btn btn-secondary btn-sm">
                              <i class="ri-arrow-left-line me-1"></i> Back to Foods
                         </a>
                    </div>
                    <div class="card-body">
                         <form action="{{ route('admin.food.update', $menu) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                                   ...
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             ...
                                             <div class="input-group">
                                                  ...
                                                  <input type="number" step="0.01" min="0" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', $menu->price) }}" required>
                                                  @error('price')
                                                       <div class="invalid-feedback">{{ $message }}</div>
                                                  @enderror
                                             </div>
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             ...
                                             <input type="number" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', $menu->sort_order) }}" min="0">
                                             @error('sort_order')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                                        </div>
                                   ...
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             <div class="form-check">
                                                  <input class="form-check-input" type="checkbox" id="is_popular" name="is_popular" value="1" {{ old('is_popular', $menu->is_popular) ? 'checked' : '' }}>
                              ...
                              <div class="mb-3">
                                   ...
                                   <div class="mb-3" id="current-image-container">
                                        <div class="d-flex align-items-center gap-3">
                                             <img id="current-image" src="{{ $menu->image_url }}" alt="{{ $menu->name }}" class="rounded" style="width: 100px; height: 100px; object-fit: cover;" onerror="this.src='{{ asset('images/placeholder-menu.png') }}'">
                                             <div>
                                   ...
                                   <div class="dropzone bg-light-subtle py-4" id="image-dropzone">
                                        ...
                                        <div class="dz-message needsclick text-center">
                                             ...
                                             <h4 class="mt-3">Drop your image here, or <span class="text-primary">click to browse</span></h4>
                              ...
                              <div class="d-flex gap-2">
                                   <button type="submit" class="btn btn-primary">
                                        <i class="ri-save-line me-1"></i> Update Food
                                   </button>
