@extends('layouts.vertical', ['title' => 'Create Review'])
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add New Review</h4>
                            ...
                            <form action="{{ route('admin.reviews.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Upload a profile image for the customer. Max size: 2MB</div>
                                </div>
