@extends('layouts.vertical', ['title' => 'Edit Gallery Image'])
                                   ...
                                   <div class="row">
                                        <div class="col-lg-8">
                                             ...
                                             <div class="mb-3">
                                                  ...
                                                  @if($gallery->image)
                                                       <div class="mb-2">
                                                            <img src="{{ $gallery->image_url }}" alt="Current Image" class="img-thumbnail" style="max-width: 300px;">
                                                            <p class="text-muted small">Current image</p>
                                                       </div>
                                                  @endif
                                                  <input type="file" class="form-control @error('image') is-invalid @enderror" 
                                                         id="image" name="image" accept="image/*">
                                                  <div class="form-text">Recommended size: 800x600px. Max file size: 5MB. Leave empty to keep current image.</div>
                                                  @error('image')
                                                       <div class="invalid-feedback">{{ $message }}</div>
                                                  @enderror
                                             </div>
                                             ...
                                             <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control @error('description') is-invalid @enderror" 
                                                            ...
                                                            placeholder="Optional description for the image">{{ old('description', $gallery->description) }}</textarea>
                                                  @error('description')
                                                       <div class="invalid-feedback">{{ $message }}</div>
                                                  @enderror
                                             </div>
