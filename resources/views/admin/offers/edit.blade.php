@extends('layouts.vertical', ['title' => 'Edit Offer'])
          ...
          <div class="col-12">
               <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                         <h4 class="card-title">Edit Offer: {{ $offer->name }}</h4>
                    ...
                    <div class="card-body">
                         <form action="{{ route('admin.offer.update', $offer) }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                   ...
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control @error('food_name') is-invalid @enderror" id="food_name" name="food_name" value="{{ old('food_name', $offer->food_name) }}" required>
                                             @error('food_name')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                                        </div>
                                   ...
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             ...
                                             <select class="form-control @error('offer_type') is-invalid @enderror" id="offer_type" name="offer_type" required>
                                                  ...
                                                  <option value="hot" {{ old('offer_type', $offer->offer_type) == 'hot' ? 'selected' : '' }}>Hot</option>
                                                  <option value="discount" {{ old('offer_type', $offer->offer_type) == 'discount' ? 'selected' : '' }}>Discount</option>
                                             </select>
                                             @error('offer_type')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                              ...
                              <div class="row" id="discount_amount_row" style="{{ old('offer_type', $offer->offer_type) == 'discount' ? '' : 'display: none;' }}">
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             <label for="discount_amount" class="form-label">Discount Amount (%)</label>
                                             <input type="number" step="0.01" min="0" max="100" class="form-control @error('discount_amount') is-invalid @enderror" id="discount_amount" name="discount_amount" value="{{ old('discount_amount', $offer->discount_amount) }}">
                              ...
                              <div class="row">
                                   <div class="col-md-4">
                                        <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control @error('tag_1') is-invalid @enderror" id="tag_1" name="tag_1" value="{{ old('tag_1', $offer->tag_1) }}" maxlength="50">
                                             @error('tag_1')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                                        </div>
                                   ...
                                   <div class="col-md-4">
                                        <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control @error('tag_2') is-invalid @enderror" id="tag_2" name="tag_2" value="{{ old('tag_2', $offer->tag_2) }}" maxlength="50">
                                             @error('tag_2')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                                        </div>
                                   ...
                                   <div class="col-md-4">
                                        <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control @error('tag_3') is-invalid @enderror" id="tag_3" name="tag_3" value="{{ old('tag_3', $offer->tag_3) }}" maxlength="50">
                                             @error('tag_3')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                                        </div>
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="mb-3">
                                             ...
                                             <input type="number" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', $offer->sort_order) }}" min="0">
                                             @error('sort_order')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                             @enderror
                                        </div>
                                   ...
                                   @if($offer->food_image)
                                        <div class="mb-3">
                                             <div class="d-flex align-items-center gap-3">
                                                  <img src="{{ $offer->image_url }}" alt="Current Image" class="rounded" style="width: 100px; height: 100px; object-fit: cover;">
                                                  <div>
                                                       <p class="mb-1 text-muted">Current Image</p>
                                                       <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="remove_current_image" name="remove_current_image" value="1">
